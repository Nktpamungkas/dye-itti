  ...
  <table width="100%" border="" class="table-list1">
    ...
    <tr>
      ...
      <td valign="top" style="border-left:0px #000000 solid;border-right:0px #000000 solid;">:
        <?php echo $rowmt2['l_r']; ?><?php $rowmt2_lr2 = $rowmt2['l_r_2'];if (! empty($rowmt2_lr2)) {echo " / " . $rowmt2_lr2;}?></td>
      <td valign="top" style="border-left:0px #000000 solid;">
        <pre>LB5 = </pre>
          <?php echo $rowmt2['lb5']; ?></pre>
      </td>
    </tr>
    <tr>
      <td style="border-right:0px #000000 solid;">
    ...
    <tr>
      ...
      <td colspan="4" align="left" valign="top" style="border-left:0px #000000 solid;">:
        <?php
            //echo $rowmt['a_panas'];
        ?>
    </td> -->

      <td align="left" rowspan="2" colspan="5" valign="top" style="#000000 solid;"></td>
