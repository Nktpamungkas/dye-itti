      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <!-- <div class="pull-right">
            <a href="pages/cetak/cetak_lapsalahresep.php?awal=<?php echo $_POST['awal']; ?>&akhir=<?php echo $_POST['akhir']; ?>" class="btn btn-danger <?php if ($_POST['awal'] == "") {
                                                                                                                                                          echo "disabled";
                                                                                                                                                        } ?>" target="_blank">Cetak Lap Salah Resep</a> 
        </div> -->
        </div>
        <div class="box-body">
          <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
            <thead class="bg-blue">
              <tr>
                ...
                <th>
                  <div align="center">PO Greige</div>
                </th>
                <th>
                  <div align="center">Cocok Warna</div>
                </th>
                <th>
                  <div align="center">Tgl Approve</div>
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              if ($Awal != "") {
                $tgl = " AND DATE_FORMAT( a.approve_at, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' ";
              } else {
                $tgl = " ";
              }
              if ($Awal != "" or $RCode != "") {
              ...
              ?>
                <tr bgcolor="<?php echo $bgcolor; ?>">
                  ...
                  <td align="center">
                    <div class="btn-group">
                      <a style="color: black;" target="_blank" href="pages/cetak/setting-resep.php?idkk=<?php echo $row1['idm'] ?>" class="btn btn-xs btn-warning">Print ! &nbsp;<i class="fa fa-print"></i></a>
                    </div>
                  </td>
