                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select name="ok_ke" class="form-control select2" style="width: 100%">
                                                                        ...
                                                                        <?php while ($row_percobaanke 	= mysqli_fetch_array($q_percobaanke)) { ?>
                                                                            <option value="<?= $row_percobaanke['id']; ?>" <?php if($_POST['ok_ke'] == $row_percobaanke['id']){ echo "SELECTED"; } ?>>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select class="form-control select2" style="width: 100%" name="pemberi_resep">
                                                                        ...
                                                                        ?>
                                                                        <?php while ($row_staff 	= mysqli_fetch_array($q_staff)) { ?>
                                                                            <option value="<?= $row_staff['nama']; ?>" <?php if($row_staff['nama'] == $row_history_matching['pemberi_resep']){ echo "SELECTED"; } ?>><?= $row_staff['nama']; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select class="form-control select2" style="width: 100%" name="operator_matcher">
                                                                        ...
                                                                        ?>
                                                                        <?php while ($row_staff 	= mysqli_fetch_array($q_staff)) { ?>
                                                                            <option value="<?= $row_staff['nama']; ?>" <?php if($row_staff['nama'] == $row_history_matching['operator_matcher']){ echo "SELECTED"; } ?>><?= $row_staff['nama']; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                            </div>
