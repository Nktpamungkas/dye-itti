...
?>          
          <body>
            <div class=e72_204>
				...
				<a href="#"><div id="1450" class="e72_177<?php echo NoMesin("1450"); ?> detail_status"><?php echo Waktu("1450","3"); ?><?php $suhu=Suhu("1450"); if($suhu>0){ ?><div class="small-round-icon"><?php echo $suhu;?> <i class="fa fa-thermometer-full"></i></div><?php } ?></div></a>
				<a href="#"><div id=" 1409" class="e72_178<?php echo NoMesin("1409"); ?> detail_status"><?php echo Waktu("1409","3"); ?><?php $suhu=Suhu("1409"); if($suhu>0){ ?><div class="small-round-icon"><?php echo $suhu;?> <i class="fa fa-thermometer-full"></i></div><?php } ?></div></a>
