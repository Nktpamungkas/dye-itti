        ...
        <div class="box-body">
          <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
            ...
            <tbody>
              ...
              if ($NCP != "") {
                $where2 = " AND no_ncp_gabungan='$NCP' ";
              } else {
                $where2 = " ";
              }
              if ($IDNCP != "") {
              ...
              ?>
                <tr bgcolor="<?php echo $bgcolor; ?>">
                  ...
                  <td align="center"><?php if ($row1['delay'] > 0) {
                    ...
                    <a href="#" class="posisi_kk" id="<?php echo $nokk1; ?>"><?php echo $nokk1; ?></a>
                  </td>
                  <td>
                  ...
                  <td align="center">
                    <font size="-1"><?php echo $row1['no_order']; ?></font><br><a href="?p=penyelesaian-new&id=<?php echo $row1['id']; ?>" class="btn"><span class="label label-danger"><?php echo $row1['no_ncp_gabungan']; ?></span></a><br>
                    <?php echo $row1['nokk']; ?>
